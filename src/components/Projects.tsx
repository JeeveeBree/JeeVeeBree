  ...
  return (
    <>
      ...
      <p>
        ...
        building space and I've chosen to go with an AMD CPU coupled with an AMD
        GPU. These are the most important parts I think and although I have
        preferences in motherboard, ram, memory, cooling and psu manufacturers I
      ...
      <p>
        ...
        9070XT, I'm just not sure yet which AIB-partner is the best for me. For
        example the Asrock Steel Legend RX 9070XT is the most budget friendly
        but not the best performer. While something like a Powercolor Red Devil
        RX 9070XT is more performant and better for overclocking, but is 22%
